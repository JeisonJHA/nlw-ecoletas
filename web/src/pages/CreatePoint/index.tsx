...
const CreatePoint: React.FC = () => {
  const [itemsToSelect, setItemsToSelect] = useState<Item[]>([]);
  ...
  useEffect(() => {
    api.get('items').then((response) => setItemsToSelect(response.data));
  }, []);
  ...
  function handleChangeUf(event: ChangeEvent<HTMLSelectElement>): void {
  ...
  async function handleSubmit(event: FormEvent): Promise<void> {
    ...
    // TODO: success page
    alert('Point de coleta cadastrado');
    history.push('/');
  }
